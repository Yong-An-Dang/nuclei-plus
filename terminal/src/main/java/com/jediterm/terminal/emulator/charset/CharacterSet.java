...
public enum CharacterSet {
    ...
    /**
     * Creates a new {@link com.jediterm.terminal.emulator.charset.CharacterSet} instance.
     *
    ...
    /**
     * Returns the {@link com.jediterm.terminal.emulator.charset.CharacterSet} for the given character.
     *
     * @param designation the character to translate to a {@link com.jediterm.terminal.emulator.charset.CharacterSet}.
     * @return a character set name corresponding to the given character,
     * defaulting to ASCII if no mapping could be made.
     */
    public static com.jediterm.terminal.emulator.charset.CharacterSet valueOf(char designation) {
        for (com.jediterm.terminal.emulator.charset.CharacterSet csn : values()) {
