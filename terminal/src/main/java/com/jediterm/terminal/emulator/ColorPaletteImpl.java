...
public class ColorPaletteImpl extends ColorPalette {
    ...
    public static final ColorPalette XTERM_PALETTE = new com.jediterm.terminal.emulator.ColorPaletteImpl(XTERM_COLORS);
    ...
    public static final ColorPalette WINDOWS_PALETTE = new com.jediterm.terminal.emulator.ColorPaletteImpl(WINDOWS_COLORS);
