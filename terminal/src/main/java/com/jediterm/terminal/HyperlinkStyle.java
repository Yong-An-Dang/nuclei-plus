...
public class HyperlinkStyle extends TextStyle {
    ...
    public static class Builder extends TextStyle.Builder {
        ...
        private Builder(@NotNull com.jediterm.terminal.HyperlinkStyle style) {
        ...
        @NotNull
        public com.jediterm.terminal.HyperlinkStyle build() {
            return build(false);
        }

        @NotNull
        public com.jediterm.terminal.HyperlinkStyle build(boolean keepColors) {
            ...
            return new com.jediterm.terminal.HyperlinkStyle(keepColors, foreground, background, myLinkInfo, myHighlightMode, myPrevTextStyle);
        }
    }
}
