...
public class TerminalPanel extends JComponent implements TerminalDisplay, TerminalActionProvider {
    private static final Logger LOG = LoggerFactory.getLogger(com.jediterm.terminal.ui.TerminalPanel.class);
    ...
    public void init(@NotNull JScrollBar scrollBar) {
        ...
        addMouseMotionListener(new MouseMotionAdapter() {
            ...
            public void mouseDragged(final MouseEvent e) {
                ...
                if (mySelection == null) {
                    // prevent unlikely case where drag started outside com.jediterm.terminal panel
    ...
    private void handleHyperlinks(@NotNull Point panelPoint, boolean isControlDown) {
        com.jediterm.terminal.ui.Cell cell = panelPointToCell(panelPoint);
        ...
        if (linkHoverConsumer != myLinkHoverConsumer) {
            ...
            if (linkHoverConsumer != null) {
                com.jediterm.terminal.ui.LineCellInterval lineCellInterval = findIntervalWithStyle(cell, linkStyle);
    ...
    private @NotNull com.jediterm.terminal.ui.LineCellInterval findIntervalWithStyle(@NotNull com.jediterm.terminal.ui.Cell initialCell, @NotNull HyperlinkStyle style) {
        ...
        return new com.jediterm.terminal.ui.LineCellInterval(initialCell.getLine(), startColumn, endColumn);
    }
    ...
    private @Nullable HyperlinkStyle findHyperlink(@Nullable com.jediterm.terminal.ui.Cell cell) {
    ...
    static class WeakRedrawTimer implements ActionListener {
        ...
        private WeakReference<com.jediterm.terminal.ui.TerminalPanel> ref;

        public WeakRedrawTimer(com.jediterm.terminal.ui.TerminalPanel terminalPanel) {
            this.ref = new WeakReference<com.jediterm.terminal.ui.TerminalPanel>(terminalPanel);
        }

        @Override
        public void actionPerformed(ActionEvent e) {
            com.jediterm.terminal.ui.TerminalPanel terminalPanel = ref.get();
            if (terminalPanel != null) {
                ...
                if (terminalPanel.needRepaint.getAndSet(false)) {
                    try {
                        ...
                        LOG.error("Error while com.jediterm.terminal panel redraw", ex);
                    }
                }
    ...
    private @NotNull Point panelToCharCoords(final Point p) {
        com.jediterm.terminal.ui.Cell cell = panelPointToCell(p);
        return new Point(cell.getColumn(), cell.getLine());
    }

    private @NotNull com.jediterm.terminal.ui.Cell panelPointToCell(@NotNull Point p) {
        ...
        return new com.jediterm.terminal.ui.Cell(y, x);
    }
    ...
    // also called from com.intellij.com.jediterm.terminal.JBTerminalPanel
    ...
    public class TerminalCursor {
        ...
        void drawCursor(String c, Graphics2D gfx, TextStyle style) {
            ...
            int width = Math.min(textLength * com.jediterm.terminal.ui.TerminalPanel.this.myCharSize.width, com.jediterm.terminal.ui.TerminalPanel.this.getWidth() - xCoord);
...
//      }
    ...
    public @Nullable Rectangle getBounds(@NotNull TerminalLineIntervalHighlighting highlighting) {
        ...
        if (index >= 0 && !highlighting.isDisposed()) {
            return getBounds(new com.jediterm.terminal.ui.LineCellInterval(index, highlighting.getStartOffset(), highlighting.getEndOffset() + 1));
        }
        return null;
    }

    private @NotNull Rectangle getBounds(@NotNull com.jediterm.terminal.ui.LineCellInterval cellInterval) {
        ...
        if (popupMenuGroupProvider != null) {
            TerminalAction.addToMenu(popup, new TerminalActionProvider() {
                ...
                public TerminalActionProvider getNextProvider() {
                    return com.jediterm.terminal.ui.TerminalPanel.this;
                }
    ...
    /**
     * @param keepLastLine true to keep last line (e.g. to keep com.jediterm.terminal prompt)
     *                     false to clear entire com.jediterm.terminal panel (relevant for com.jediterm.terminal console)
     */
    ...
    private class TerminalKeyHandler extends KeyAdapter {
        ...
        public void keyPressed(KeyEvent e) {
            ...
            if (TerminalAction.processEvent(com.jediterm.terminal.ui.TerminalPanel.this, e) || processTerminalKeyPressed(e)) {
                e.consume();
    ...
    private class MyInputMethodRequests implements InputMethodRequests {
        ...
        public Rectangle getTextLocation(TextHitInfo offset) {
            Rectangle r = new Rectangle(myCursor.getCoordX() * myCharSize.width + getInsetX(), (myCursor.getCoordY() + 1) * myCharSize.height,
                    0, 0);
            Point p = com.jediterm.terminal.ui.TerminalPanel.this.getLocationOnScreen();
            r.translate(p.x, p.y);
            return r;
        }
