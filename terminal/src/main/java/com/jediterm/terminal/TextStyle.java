...
public class TextStyle {
    ...
    public static final com.jediterm.terminal.TextStyle EMPTY = new com.jediterm.terminal.TextStyle();

    private static final WeakHashMap<com.jediterm.terminal.TextStyle, WeakReference<com.jediterm.terminal.TextStyle>> styles = new WeakHashMap<>();
    ...
    @NotNull
    public static com.jediterm.terminal.TextStyle getCanonicalStyle(com.jediterm.terminal.TextStyle currentStyle) {
        if (currentStyle instanceof HyperlinkStyle) {
            return currentStyle;
        }
        final WeakReference<com.jediterm.terminal.TextStyle> canonRef = styles.get(currentStyle);
        if (canonRef != null) {
            final com.jediterm.terminal.TextStyle canonStyle = canonRef.get();
            if (canonStyle != null) {
                return canonStyle;
            }
        }
    ...
    public com.jediterm.terminal.TextStyle createEmptyWithColors() {
        return new com.jediterm.terminal.TextStyle(myForeground, myBackground);
    }
    ...
    public boolean equals(Object o) {
        ...
        com.jediterm.terminal.TextStyle textStyle = (com.jediterm.terminal.TextStyle) o;
    ...
    public static class Builder {
        ...
        public Builder(@NotNull com.jediterm.terminal.TextStyle textStyle) {
        ...
        @NotNull
        public com.jediterm.terminal.TextStyle build() {
            return new com.jediterm.terminal.TextStyle(myForeground, myBackground, myOptions);
        }
    }
}
