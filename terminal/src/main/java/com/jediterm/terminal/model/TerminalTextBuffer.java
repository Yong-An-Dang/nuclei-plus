...
public class TerminalTextBuffer {
    private static final Logger LOG = LoggerFactory.getLogger(com.jediterm.terminal.model.TerminalTextBuffer.class);
    ...
    /**
     * Returns com.jediterm.terminal lines. Negative indexes are for history buffer. Non-negative for screen buffer.
     *
